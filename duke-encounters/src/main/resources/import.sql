-- USERS
INSERT INTO users (id, firstname, lastname, email, username, password, registration_date, level, enabled) VALUES (1, 'Arthur', 'Dent', 'arthur@dent.com', 'arthur@dent.com', '$2a$10$UYOseFWgR87PwL2j8VmycO.IjuH2uGht3lGFGBn2ShUUS9B4zclIe', '2010-05-05 10:45:33', 'PRO', TRUE);
INSERT INTO users (id, firstname, lastname, email, username, password, registration_date, level, enabled) VALUES (2, 'Ford', 'Prefect', 'ford@prefect.com', 'ford@prefect.com', '$2a$10$8yg/hBDXP0bpQuuKJneYbucl0/NsjfT1zQjMsEcnFrjt.6tVnrAEW', '2012-10-01 11:02:29', 'ROOKIE', TRUE);
...
INSERT INTO users (id, firstname, lastname, email, username, password, registration_date, level, enabled) VALUES (4, 'Marvin', null, 'marvin@marvin.com', 'marvin@marvin.com', '$2a$10$PL7R5GjZX2xJJDaGK9PSsuq4nUWM4v9XaBC0lsIRYhv8OpHFEMl8u', '2010-01-01 08:52:11', 'NEWBIE', TRUE);
...
INSERT INTO users (id, firstname, lastname, email, username, password, registration_date, level, enabled) VALUES (8, 'Tricia', 'McMillan', 'tricia@mcmillan.com', 'tricia@mcmillan.com', '$2a$10$ubWNmc1TD8gDpBTR2Tfl9eE0lvYEZmB4dyvd47KLCLnTAnjNCA0e2', '2014-05-05 08:52:11', 'ROOKIE', TRUE);
INSERT INTO users (id, firstname, lastname, email, username, password, registration_date, level, enabled) VALUES (9, 'Slartibartfast', null, 'slartibartfast@slartibartfast.com', 'slartibartfast@slartibartfast.com', '$2a$10$8lFXL0sPVQERcfJIG.UaIuPjoo9xeSRRdk8.Z20FdujLqohdvy8WO', '2015-06-06 08:52:11', 'NEWBIE', TRUE);
...
-- ROLES
INSERT INTO roles(id, rolename, role, username) VALUES (1, 'user', 'ROLES_USER', 'arthur@dent.com');
